    ...
    <div className="w-full h-full flex flex-col justify-center items-center text-white p-8 border-4 border-gray-700">
        ...
        <div className="text-lg bg-black bg-opacity-30 p-6 border border-gray-700 rounded-sm w-full max-w-lg">
            ...
            <ul className="list-none text-center space-y-3 font-cinzel text-gray-400">
                <li className="fading-name block" style={{ animationDelay: '0s' }}>Mateus Natan Maoski</li>
                <li className="fading-name block" style={{ animationDelay: '0.2s' }}>Afonso Henrique de Christo Muller</li>
                <li className="fading-name block" style={{ animationDelay: '0.4s' }}>João Pedro Cardoso de Liz</li>
            </ul>
        </div>
